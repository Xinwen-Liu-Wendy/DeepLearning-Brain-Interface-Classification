...
<img src="./model_architecture.png" alt="alt text" width="1000" height="350"> <br>
...
## Performance
The accuracy trajectory during training, average accuracy of individual subjects and confusion matrix of classification accuracy of each class are shown as a, b, c for all three models. <br>
CNN <br>
<img src="./CNN_performance.png" alt="alt text" width="1000" height="350"> <br>
CNN-LSTM <br>
<img src="./CNN-LSTM_performance.png" alt="alt text" width="1000" height="350"> <br>
CNN-Transformer <br>
<img src="./CNN-Transformer_performance.png" alt="alt text" width="1000" height="350"> <br>
